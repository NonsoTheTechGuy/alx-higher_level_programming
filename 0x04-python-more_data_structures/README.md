# 0x04. Python - More Data Structures: Set, Dictionary 💂‍♂️
## `Python` 
## Resources
## Read or watch:
...
- Prototype: `ef print_sorted_dictionary(a_dictionary)`:
...
- Prototype: `ef complex_delete(a_dictionary, value)`:
...
![image](https://github.com/NonsoTheTechGuy/alx-higher_level_programming/assets/92136146/e225c7f5-1ae3-4946-8bd2-857d23a44089)

`Python lists`:

- Prototype: `oid print_python_list(PyObject *p)`;
- Format: see example
...
- If `p` is not a valid `yBytesObject`, print an error message (see example)
