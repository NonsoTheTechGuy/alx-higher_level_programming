...
## `Python`
 ...
 ![image](https://github.com/NonsoTheTechGuy/alx-higher_level_programming/assets/92136146/13ee09e7-7dd3-44b9-b4fd-937d2454c7d3)
...
- The output of the program should be:
  ...
  - the string is, followed by the last digit of `number`, followed by
    ...
    - if the last digit is 0: the string `andis 0`
