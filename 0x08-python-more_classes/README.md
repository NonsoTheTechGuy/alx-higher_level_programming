# Project - 0x08. Python - More Classes and Objects 💂‍♂️
# `Python`
# Resources
...
- What is the difference between `_str__` and `__repr__`
...
- GitHub repository: `alx-higher_level_programming`
- Directory: `x08-python-more_classes`
- File: `5-rectangle.py`
...
- Public class attribute `number_of_instances`:
   ...
   - Incremented during each new instance instantiation
   - Decremented during each instance deletion
- Public class attribute `rint_symbol`:
   - Initialized to `#`
   - Used as symbol for string representation
   - Can be any type
- Instantiation with optional width and height: `def __init__(self, width=0, height=0)`:
...
`advanced`
 ...
 ![image](https://github.com/NonsoTheTechGuy/alx-higher_level_programming/assets/92136146/302f52c5-c59c-42a4-90a3-bd84400c9dc8)
